...
String id = id_produto_venda.getText();
    ...
    if (id.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Por favor, insira o ID do produto a ser vendido.");
        return;
    }
    ...
    try {
        ...
        produtosdao.venderProduto(idProduto); // Chama o método venderProduto
        listarProdutos(); // Atualiza a lista de produtos na tabela
        id_produto_venda.setText(""); // Limpa o campo de texto
    ...
    vendasVIEW vendas = new vendasVIEW();  // Abre a tela de vendas
